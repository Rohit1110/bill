...
public abstract class ExpandableRecyclerAdapter<PVH extends ListOneAdapter, CVH extends ChildViewHolder>
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ListOneAdapter.ParentListItemExpandCollapseListener {
...
/**
    ...
    private List<? extends Listone> mParentItemList;
...
/**
     ...
     *
     * @param parentItemList List of all {@link Listone} objects to be
     *                       displayed in the RecyclerView that this
     *                       adapter is linked to
     *//*

    public ExpandableRecyclerAdapter(List<? extends Listone> parentItemList) {
        super();
...
/**
    ...
    public void expandParent( Listone*/
/**//*
) {
