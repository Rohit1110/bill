...
public class VendorDashBoard extends Fragment {
    private ConstraintLayout layout_total_orders, layout_manage_newspapers, layout_accounting, layout_transactions, layout_settings;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       /* toolbar.setTitle("Title");
        ...
        layout_accounting = rootView.findViewById(R.id.layout_bill_summary);
        layout_transactions = rootView.findViewById(R.id.layout_transactions);
